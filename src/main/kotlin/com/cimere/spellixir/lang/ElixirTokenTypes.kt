...
object ElixirTokenTypes {
    ...
    val FUNCTION_DECLARATION = ElixirTokenType("FUNCTION_DECLARATION")
    val MEMBER_ACCESS = ElixirTokenType("MEMBER_ACCESS")
    val ALIAS = ElixirTokenType("ALIAS")
    val ATOM = ElixirTokenType("ATOM")
    val LITERAL = ElixirTokenType("LITERAL")
    ...
    val CAPTURE = ElixirTokenType("CAPTURE")
    val ESCAPE = ElixirTokenType("ESCAPE")
    val INTERPOLATION = ElixirTokenType("INTERPOLATION")
